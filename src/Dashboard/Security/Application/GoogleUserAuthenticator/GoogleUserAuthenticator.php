...
namespace App\Dashboard\Security\Application\GoogleUserAuthenticator;
...
class GoogleUserAuthenticator extends AbstractAuthenticator
{
    ...
    public function supports(Request $request): ?bool
    {
        ...
        return UserProvider::GOOGLE === $provider;
    }
